...
const filters = [
  ...
  },
  {
    ...
    name: 'Price',
    options: [
      { value: 'low', label: '-10,000,000 XAF' },
      { value: 'high', label: '+10,000,000 XAF' },
    ],
  },
];
...
export default function CarFilterApp() {
  ...
  const apartments = [
    {
      ...
      price: "5 000 000",
      District: "Deido",
      imageUrl: "/Gallery/voitures/c4.jpg",
    ...
    {
      id: 3,
      title: "Mercedes Brabus",
      bathrooms: 2,
      bedrooms: 2,
      price: "20 000 000",
      District: "Bonandjo",
      imageUrl: "/Gallery/voitures/c3.jpg",
    ...
    },
    {
      ...
      price: "25 000 000",
      District: "Ndokoti",
      imageUrl: "/Gallery/voitures/c1.jpg",
      description: "A luxurious 4-bedroom house with a large garden and pool.",
    },
    {
      id: 5,
      ...
      price: "25 000 000",
      District: "Ndokoti",
      imageUrl: "/Gallery/voitures/c8.jpg",
      description: "A luxurious 4-bedroom house with a large garden and pool.",
    },
    {
      id: 6,
      ...
      price: "25 000 000",
      District: "New Bell",
      imageUrl: "/Gallery/voitures/c6.jpg",
      description: "A luxurious 4-bedroom house with a large garden and pool.",
    },
  ];
