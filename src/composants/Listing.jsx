    ...
    <section className="py-10">
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
          {/* Première image */}
          <a
            className="max-w-[384px] mx-auto hover:text-yellow-500 group transition-all duration-500 zoom"
          >
            <div className="w-full max-w-sm aspect-square">
              <img
                ...
                onClick={() => openModal('/Gallery/1.jpg')}
              />
            </div>
            <div className="mt-5 flex items-center justify-between">
              <div>
                <h6 className="font-medium text-xl leading-8 text-black group-hover:text-yellow-600 transition-all duration-500 zoom">
                  Passion Twist
                </h6>
              </div>
              {/* Bouton */}
              <button className="p-2 min-[400px]:p-4 rounded-full bg-white border border-gray-300 flex items-center justify-center group shadow-sm shadow-transparent transition-all duration-500 zoom hover:shadow-gray-200 hover:border-yellow-400 hover:bg-gray-50">
          ...
          <a
            ...
            <div className="w-full max-w-sm aspect-square">
              <img
                ...
                alt="Box Braids"
                className="w-full h-full rounded-xl object-cover cursor-pointer"
                onClick={() => openModal('/Gallery/4.jpg')}
              />
            </div>
            <div className="mt-5 flex items-center justify-between">
              <div>
          ...
          >
            <div className="w-full max-w-sm aspect-square">
              <img
                ...
                alt="Cornrows"
                className="w-full h-full rounded-xl object-cover cursor-pointer"
                onClick={() => openModal('/Gallery/13.jpg')}
              />
            </div>
            <div className="mt-5 flex items-center justify-between">
              <div>
          ...
          <a
            ...
            <div className="w-full max-w-sm aspect-square">
              <img
                ...
                alt="Knotless Braids"
                className="w-full h-full rounded-xl object-cover cursor-pointer"
                onClick={() => openModal('/Gallery/11.jpg')}
              />
            </div>
            <div className="mt-5 flex items-center justify-between">
              <div>
          ...
          <a
            ...
            <div className="w-full max-w-sm aspect-square">
              <img
                ...
                alt="Microlocs"
                className="w-full h-full rounded-xl object-cover cursor-pointer"
                onClick={() => openModal('/Gallery/14.jpg')}
              />
            </div>
            <div className="mt-5 flex items-center justify-between">
              <div>
          ...
          <a
            ...
            <div className="w-full max-w-sm aspect-square">
              <img
                ...
                alt="Medium Braids"
                className="w-full h-full rounded-xl object-cover cursor-pointer"
                onClick={() => openModal('/Gallery/6.jpg')}
              />
            </div>
            <div className="mt-5 flex items-center justify-between">
              <div>
      ...
      {isOpen && (
        ...
        >
          <div className="bg-white p-4 rounded-lg max-h-[80%]">
            ...
            <button
              onClick={closeModal}
              className="absolute top-4 right-4  text-white bg-yellow-600 p-4 hover:bg-white hover:text-yellow-600 duration-300 rounded-full font-semibold"
            >
              Fermer
            </button>
          </div>
