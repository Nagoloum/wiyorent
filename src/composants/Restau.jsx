...
const filters = [
  ...
  },
  {
    ...
    name: 'Price',
    options: [
      { value: 'low', label: '-20,000 XAF' },
      { value: 'high', label: '+20,000 XAF' },
    ],
  },
];
...
export default function HouseFilterApp() {
  ...
  const apartments = [
    {
      ...
      price: "30 000",
      District: "Deido",
      imageUrl: "/Gallery/restaurant/r1.jpg",
    ...
    },
    {
      ...
      price: "15 000",
      District: "Akwa",
      imageUrl: "/Gallery/restaurant/r2.jpg",
    ...
    },
    {
      ...
      price: "20 000",
      District: "Bonandjo",
      imageUrl: "/Gallery/restaurant/restau.jpg",
  ...
  const filteredApartments = apartments.filter((apartment) => {
    ...
    const priceMatch = selectedFilters.price.length === 0 ||
      (selectedFilters.price.includes('low') && price < 20000) ||
      (selectedFilters.price.includes('high') && price >= 20000);
