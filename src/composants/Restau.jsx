...
export const Restau = [
  {
    ...
    price: "100 000",
    District: "Deido",
    imageUrl: ["/Gallery/restaurant/r1.jpg", "/Gallery/restaurant/r2.jpg", "/Gallery/restaurant/r1.jpg"],
  ...
  },
  {
    ...
    price: "350 000",
    District: "Akwa",
    imageUrl: ["/Gallery/restaurant/r2.jpg", "/Gallery/restaurant/r1.jpg", "/Gallery/restaurant/r2.jpg"],
...
export default function restauFilterApp() {
  ...
  const filteredrestau = Restau.filter((restau) => {
    const parsePrice = (price) => parseInt(price.replace(/\s/g, ''), 10); // Supprime les espaces et convertit en entier

    const DistrictMatch = selectedFilters.District.length === 0 || selectedFilters.District.includes(restau.District);

    const price = parsePrice(restau.price);
    const places = restau.place;
    const surface = restau.surface;
  ...
  const sortedrestau = [...filteredrestau].sort((a, b) => {
      ...
      <div>
        ...
        <main className="mx-auto max-w-full px-4 sm:px-6 lg:px-56">
          ...
          <div className="flex flex-wrap items-baseline justify-between border-b border-gray-200 pb-6 pt-10">
            <h1 className="text-3xl sm:text-5xl font-bold tracking-tight text-gray-900">Rent Out a Restaurant</h1>
                    ...
                    >
                      ...
                      <div className="p-4">
                        ...
                        <p className="mt-2 text-gray-700 flex items-center gap-2">
                          ...
                          {restau.place} Place(s)
                        </p>
                        <p className="mt-4 text-lg font-bold text-black">
                          {restau.price} XAF <span className="text-gray-400 text-base">/day</span>
                        </p>
                      </div>
                      <div className="absolute bottom-4 right-4 group">
                        <a
                          onClick={() => handleNavigate(restau.type, restau.id)}
